...
define(function(require){
	...
	var _ 					= require("underscore"),
		...
		helpers				= require("mod/helpers/helper_util"),
		templNavi			= require("text!mod/templates/tmpl_mProjects_navi.html"),
		templProjects   	= require("text!mod/templates/tmpl_mProjects_projects.html"),
		templNewCreatEntries= require("text!mod/templates/tmpl_mProjects_newCreatedUserEntries.html"),
		Model_Project 		= require("mod/models/m_mProjects"), 
		Collection_Projects = require("mod/collections/c_mProjects"),
